...
void solve(long long n, long long x, long long y, long long** matrix)
{
    MATRIX_swap_X_Rows_with_Y_Rows(matrix, n, x, y);
    MATRIX_swap_X_Columns_with_Y_Columns(matrix, n, x, y);
    for (long long i = 0; i < n; ++i)
    {
        for (long long j = 0; j < n; ++j)
        {
